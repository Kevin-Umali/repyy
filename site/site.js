...
const docsGlobalIndex = [
  ...
  ['/coverage/','Detection coverage','supply-chain','Supply-chain files by ecosystem','npm yarn pnpm pip uv bundler go cargo gradle maven composer nuget package sources build scripts wrappers'],

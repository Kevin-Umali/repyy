...
var ruleQualityManifest = []ruleQualityGroup{
	{
		...
		RuleIDs: []string{
			...
			"UNICODE-001", "IDE-001", "IDE-002", "AGENT-001", "AGENT-002", "CICD-001", "CICD-002", "CICD-004", "CICD-005",
			"DOCKER-001", "DOCKER-002", "DOCKER-003", "GITHOOK-001", "GITMETA-001", "NPMRC-001", "NPMRC-002", "LOCK-001",
			"TYPOSQUAT-001", "SOCIAL-001", "SOCIAL-002", "APT-001", "SECRET-001", "SECRET-002", "SECRET-003", "SHELL-001",

...
| Editor/agent execution | VS Code tasks/settings/extensions, devcontainers, JetBrains commands, Vim/Neovim project config, AI-agent hooks and prompt injection in common instruction-file names and formats | `IDE-*`, `AGENT-*` |

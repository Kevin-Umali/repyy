# Deferred `/threats/` page inputs

The original objective stops in Part XIV, in the middle of a `/threats/`
example after “credential steal”. Repyy has no `/threats/` page in this phase.
The remaining source requirements are unknown.

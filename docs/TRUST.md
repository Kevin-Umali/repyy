...
| Hostile inputs receive regression/fuzz tests | [internal/scan/security_regression_test.go](https://github.com/Kevin-Umali/repyy/blob/main/internal/scan/security_regression_test.go), [.github/workflows/security-evidence.yml](https://github.com/Kevin-Umali/repyy/blob/main/.github/workflows/security-evidence.yml)                                                | Bounded test runs; no exhaustive assurance                                 |
